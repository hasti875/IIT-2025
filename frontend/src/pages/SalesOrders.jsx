...
const SalesOrders = () => {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true);
      const response = await financeService.getSalesOrders();
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Manage customer sales orders and quotations</p>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          <div className="flex items-center justify-between gap-4">
            <h3 className="font-semibold text-gray-900">All Sales Orders</h3>
